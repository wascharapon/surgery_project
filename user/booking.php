...
<script language="JavaScript">
	...
	{
		if(confirm('คุณต้องการจองใช่หรือไม่')==true)
				{
					if(confirm('ยืนยันการจองคิว')==true)
						{	
			window.location.href="http://localhost/mini_project/user/php/booking_action.php?id="+id;
						}
		else
		{
...
<div class="row" ">
	...
	{	  ?> 
                    ...
                    <li class=" active"><a href="booking.php">จองคิว</a></li>
...
<div class="container" style="margin-top:6%">
	...
	{	?> 
        ...
        <img style="border:1px solid #e7e7e7;" src="img/<?php echo $bn['photo']; ?>" width="100%" />
        ...
        <div style="background-color:#000;border:1px #e7e7e7 solid">
            ...
            <br>
            <small style="color:#FFF; font-size:16px" ><p>&nbsp;&nbsp;<label style="font-size:18">รายละเอียด&nbsp;:&nbsp;</label><?php echo $bn['sub_text']; ?></p></small>
            <small style="color:#FFF;font-size:20px;" ><a class="green" OnClick="chkConfirm(<?php echo $bn['id']; ?> )"><center>จองคิว</center></a></small>
                 <br>
		</div>
          <br>
        </div>
