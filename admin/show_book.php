...
<html lang="en">
  ...
  <body class="app sidebar-mini">
      ...
      <ul class="app-menu">
        <li><a class="app-menu__item " href="index.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">ระบบสมาชิก</span></a></li>
         <li><a class="app-menu__item" href="add_data.php"><i class="app-menu__icon fa fa-edit"></i><span class="app-menu__label">เพิ่มข้อมูลศัลยกรรม</span></a></li>
          ...
          <li><a class="treeview-item active" href="show_book.php"><i class="icon fa fa-circle-o"></i>รายละเอียดการจองคิว</a></li>
    ...
    <main class="app-content">
      ...
      <div class="app-title">
        <div>
          <h1><i class="fa fa-dashboard"></i>&nbsp;&nbsp;&nbsp;รายละเอียดการจองคิว</h1>
          <p></p>
        </div>
              ...
              <table class="table table-hover table-bordered" id="sampleTable">
                <thead>
                  ...
                  <center>
                    	...
                    	<th style="text-align:center;">รหัสผู้จอง</th>
	...
	{	
                 echo " <tr>
                     <td  style=\"text-align:center;\">".$row['id']."</td>
					  <td  style=\"text-align:center;\">".$row['id_booking']."</td>
                    <td  style=\"text-align:center;\">".$row['book_surgery']."</td>
					  <td  style=\"text-align:center;\">".$row['price']."</td>
					<td style=\"color:red;text-align:center;\">".$row['confirm_status']."</td>
