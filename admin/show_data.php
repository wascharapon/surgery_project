...
<html lang="en">
  ...
  <body class="app sidebar-mini">
      ...
      <ul class="app-menu">
        <li><a class="app-menu__item " href="index.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">ระบบสมาชิก</span></a></li>
         <li><a class="app-menu__item" href="add_data.php"><i class="app-menu__icon fa fa-edit"></i><span class="app-menu__label">เพิ่มข้อมูลศัลยกรรม</span></a></li>
          <li><a class="app-menu__item active" href="show_data.php"><i class="app-menu__icon fa fa-th-list"></i><span class="app-menu__label">ตารางข้อมูลศัลยกรรม</span></a></li>
    ...
    <main class="app-content">
      ...
      <div class="app-title">
        <div>
          <h1><i class="fa fa-dashboard"></i>&nbsp;&nbsp;&nbsp;ตารางข้อมูลศัลยกรรม</h1>
          <p></p>
        </div>
