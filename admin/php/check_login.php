...
{
			echo "<script>alert('ไอดีหรือรหัสผ่านไม่ถูกต้อง');window.location.href = 'http://localhost/mini_project/admin/login.php';</script>";
}
}
else
{
		echo "<script>alert('กรุณากรอกข้อมูลให้เรียบร้อบ');window.location.href = 'http://localhost/mini_project/admin/login.php';</script>";
}
